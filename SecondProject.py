...
df = pd.read_csv('# Import the neccessary modules for data manipulation and visual representation
import pandas as pd
import numpy as np
from matplotlib import *
import matplotlib.pyplot as plt
...
# Read the analytics csv file and store our dataset into a dataframe called "df"
df = pd.read_csv('C:\Users\CHINNAMUTHU\Downloads\hr_csv.csv', index_col=None)
